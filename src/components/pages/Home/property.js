            ...
            {aboutProperty !== '' ?
                <div className="s.item">
                    ...
                    <div className={s.modes}>
                        <form>
                            <RadioCheck name="propertyType" title="Single Family" value="singleFamily"
                                        forHtml="singleFamily" change={typePropertyHandle}/>
                            <RadioCheck name="propertyType" title="Townhouse or Condo" value="condo" forHtml="condo"
                                        change={typePropertyHandle}/>
                            {aboutProperty === 'primaryResidence' || aboutProperty === 'Investment' ?
                                <RadioCheck name="propertyType" title="2 to 4 units" value="2to4units"
                                            forHtml="2to4Units" change={typePropertyHandle}/> : null}
                            <RadioCheck name="propertyType" title="Cooperative" value="cooperative"
                                        forHtml="cooperative" change={typePropertyHandle}/>
                        </form>
                    </div>
                </div> : null}
